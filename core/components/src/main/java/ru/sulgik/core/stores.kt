...
inline fun <Param : Any, reified T : ParametrizedStore<*, *, *, Param>> DIComponentContext.getParameterizedStore(
...
inline fun <Param : Any, reified T : ParametrizedStore<*, *, *, Param>> DIComponentContext.getParameterizedSavedStateStore(
    crossinline param: () -> Param,
): T {
...
inline fun <reified SavedState : Parcelable, reified State : Any, reified T : Store<*, State, *>> DIComponentContext.getSavedStateStore(
    key: String,
...
inline fun <reified State : Parcelable, reified T : Store<*, State, *>> DIComponentContext.getSavedStateStore(
    key: String,
): T {
