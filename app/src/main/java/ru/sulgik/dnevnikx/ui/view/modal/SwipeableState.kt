...
import ru.sulgik.dnevnikx.ui.view.modal.SwipeableDefaults.StandardResistanceFactor
import ru.sulgik.dnevnikx.ui.view.modal.SwipeableDefaults.VelocityThreshold
import ru.sulgik.dnevnikx.ui.view.modal.SwipeableDefaults.resistanceConfig
...
open class SwipeableState<T>(
    initialValue: T,
    internal val animationSpec: AnimationSpec<Float> = spring(),
